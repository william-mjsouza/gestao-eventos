...
public class LoteSteps {
    ...
    // Repositório mockado centralizado na CucumberSpringConfiguration
    @Autowired
    ...
    public void lote_1_ativo() {
        ...
        // Ativo: Iniciou há 5 dias e termina em 5 dias
    ...
    public void participante_seleciona_ingresso() {
        loteRecebido = loteService.obterLoteAtivo(evento.getId());
    }
    ...
    public void data_validade_lote1_expirou_ontem() {
        ...
        // Lote 1 - Expirado ontem
        lote1 = new Lote();
        lote1.setId(1L);
        lote1.setNome("Lote 1");
        lote1.setQuantidadeDisponivel(50);
        lote1.setDataInicioVenda(LocalDateTime.now().minusDays(10));
        lote1.setDataFimVenda(LocalDateTime.now().minusDays(1)); // Expirou ontem
        ...
        lote2.setDataInicioVenda(LocalDateTime.now().minusHours(2)); // Iniciou hoje
